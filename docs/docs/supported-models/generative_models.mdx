...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>Meta's open LLM series, spanning 7B to 400B parameters (Llama 2, 3, and new Llama 4) with well-recognized performance. <a href="/cookbook/autoregressive/Meta/Llama4">SGLang provides Llama-4 model-specific optimizations</a></td>
    </tr>
    <tr>
...
<tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>Liquid AI's sparse Mixture-of-Experts variant of the LFM2 hybrid backbone, with SwiGLU experts, normalized sigmoid routing, and top-k expert selection.</td>
    </tr>
<tr>
...
<tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}><strong>Falcon-RW</strong> (1B)</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}><code>tiiuae/falcon-rw-1b-chat</code></td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>TII's decoder-only Transformer architecture using multi-head self-attention and ALiBi positional biases for causal language modeling</td>
    </tr>
</tbody>
</table>
